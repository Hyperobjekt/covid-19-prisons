...
image: vaccine-reporting2.png
socialImage: vaccine-reporting2.png
isBlogPost: true
template: blog
---
...
The full range of variables reported can be found in [our dataset on GitHub](https://github.com/uclalawcovid19behindbars/data/blob/master/latest-data/state_aggregate_counts.csv). More information about how we define our variables is available on [our methodology page](https://uclacovidbehindbars.org/methods).
