...
description: In March, we released our Data Reporting & Quality Scorecards
  ...
  We provided grades for which COVID-19 data they report (our data reporting
  metrics) and how they report those data (our data quality metrics). On April
  12th, we reassessed the scores and grades for each agency. In the first round
  of assessments, 75% of correctional agencies received an F. In this round, 81%
  of agencies did.
isBlogPost: true
template: blog
---
