---
title: "UPDATE: Data Reporting & Quality Scorecard, Round 2"
path: blog/aprilscorecard
featured: true
author: Erika Tyagi, Poornima Rajeshwar, and Liz DeWolf
date: 2021-04-16T22:10:42.541Z
description: In March, we released our Data Reporting & Quality Scorecards
  assessing the transparency of each of the 53 major state and federal agencies.
  On April 12th, we reassessed the scores and grades for each agency. In the
  first round of assessments, 75% of correctional agencies received an F. In
  this round, 81% of agencies did.
socialDescription: 81% of state and federal correctional agencies received an F
  for data transparency and quality.
socialImage: screen-shot-2021-04-16-at-1.21.04-pm.png
isBlogPost: true
template: blog
---
...
Changes in grades largely resulted from the addition of scorecard metrics for vaccination data reporting, which added four points to the total possible score for each agency. As of this week, all state and federal agencies have begun providing vaccinations to at least some staff and people in custody, but not all are reporting data publicly on who and how many people are receiving them. As of this week, only 20 agencies out of 53 report some kind of vaccine data for incarcerated people. Of these reporting agencies, only 16 report vaccine data for staff.

Agencies that do report vaccination data do so in multiple ways: the number of individuals who have received at least one dose, the number of individuals who have completed their vaccination schedule, or the total number of doses administered. Agencies received points if at least one of these variables was reported.
...
![Data Reporting & Quality Scorecard for the California Department of Corrections and Rehabilitation](screen-shot-2021-04-16-at-1.21.04-pm.png "Data Reporting & Quality Scorecard for the California Department of Corrections and Rehabilitation")
