...
![A time series chart displaying a trend of minimum COVID-19 cases as estimated using our historical scraped data from the Federal Bureau of Prisons.](bop-minimum-estimate.jpg "Minimum number of people who have been infected with COVID-19 while incarcerated in federal facilities, estimated using our historical scraped data from the BOP.")
