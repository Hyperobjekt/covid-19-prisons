...
socialImage: bop-as-reported-4.2.jpg
isBlogPost: true
template: blog
---
...
![A time series chart displaying an illogical decrease in COVID-19 cases in federal prisons, as reported by the Federal Bureau of Prisons](bop-as-reported-4.2.jpg "People who have been infected with COVID-19 in federal prisons, as reported by the BOP")

When we reached out to the BOP for an explanation, a spokesperson informed us that the drop in reported cases was not, in fact, an error. Rather, it was the outcome of an intentional reporting choice. According to the spokesperson, throughout the pandemic the BOP has been removing cases from its total count whenever a person who previously tested positive is released from custody. While the definition of the COVID-19 cases variable on [the BOP's own dashboard](https://www.bop.gov/coronavirus/) (“number of inmates that have ever had a positive test”) suggests the agency is reporting cumulative cases among those who have been incarcerated during the pandemic, it actually reports cases only among those *currently incarcerated*.
...
A note on our methodology: if, on a given day, there were more new cases in a facility than releases of previously infected people, we were unable to detect the drop at all. Even when we did detect a drop in reported cases at a facility, this method understates its size unless there were no new cases in the facility that day.

![A time series chart displaying a trend of minimum COVID-19 cases as estimated using our historical scraped data from the Federal Bureau of Prisons.](bop-minimum-estimate-4.2.jpg "Minimum number of people who have been infected with COVID-19 in federal prisons, estimated using our historical BOP data ")
...
*Data analysis by and support from Erika Tyagi and Neal Marquez.*