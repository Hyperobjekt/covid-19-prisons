...
What is surprising, however, is that in recent weeks, [as noted by the Marshall Project](https://twitter.com/MarshallProj/status/1375500147384270852), the BOP has reported a decrease in that sum — an illogical trend for a number that presumably can only increase over time, as more tests come back positive. Today, it stands at 46,501.
