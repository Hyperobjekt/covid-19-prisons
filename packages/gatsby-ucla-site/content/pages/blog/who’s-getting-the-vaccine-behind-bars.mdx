...
description: We don’t know much, but what the data show so far is concerning.
...
socialImage: josh-blog-post-map-incarc-and-staff.png
isBlogPost: true
template: blog
---
...
![](josh-blog-post-map-incarc-and-staff.png)
...
![](josh-blog-post-map-reporting.png)
