...
description: We have created a scorecard to assess each of the 53 major state
  and federal carceral agencies according to a number of metrics related to what
  COVID-19 data they report and how they report those data. We assigned our
  first round of scores and grades on March X, 2021 and plan to update the
