...
We assigned our first round of scores and grades on March X, 2021. Of the 53 systems assessed, the agency with the highest grade was X, followed by Y and Z. The lowest scoring agencies were Blah and Blah. 
...
1. Cumulative cases among incarcerated people: the agency reports the number of individuals who have ever tested positive for COVID-19 while incarcerated at a particular facility

2. Cumulative deaths among incarcerated people: the agency reports the total number of individuals who have died with or from COVID-19 while incarcerated in a particular facility*

3. Cumulative tests among incarcerated people: the agency reports the total number of tests performed on incarcerated individuals throughout the pandemic\*\*

4. Active cases among incarcerated people: the agency reports number of individuals currently incarcerated at a particular facility who have an active infection of COVID-19 and have not been deemed recovered 

5. Total incarcerated population: the agency reports the total number of individuals incarcerated within a particular facility

6. Cumulative cases among staff: the agency reports total number of confirmed COVID-19 cases among staff members at a particular facility

7. Cumulative deaths among staff: the agency reports the total number of staff who have died with or from COVID-19 who worked in a particular facility

8. Cumulative tests among staff: the agency reports the total number of tests performed on staff throughout the pandemic
\* Some agencies do not include people who were positive for COVID-19 but were found to have died of another cause. Our position is that agencies should include all people who had COVID-19 and died, and note whether infection was the cause of their death.

\*\*While a few agencies report the number of people tested, the ideal metric is the number of tests administered. Monitoring for COVID-19 requires regular testing and reporting the number of people tested obscures the regularity of testing.
...
1. Machine readable: data are presented in API, json, csv, or xml formats. Static images, pdfs, and html formats are not considered machine readable

2. Regularly updated: data are updated at least once per week, with a visible timestamp

3. Clearly defined: variable definitions are visible on the agency website (e.g., in a data dictionary or table footnotes)

4. Contextualized historically: historical trends of some type are displayed on the agency website
...
**Converting Raw Scores to Grades**
