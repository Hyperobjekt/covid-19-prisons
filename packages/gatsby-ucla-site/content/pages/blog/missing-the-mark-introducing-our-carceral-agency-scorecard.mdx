...
image: screen-shot-2021-03-15-at-9.02.57-pm.png
isBlogPost: true
template: blog
---
...
The scorecards for each agency are displayed on each state page. [Click here](https://docs.google.com/spreadsheets/d/1ygkFpF7NVX4qfMs6_spaLM3Aev-JvnGakvWPCkDNuDk/edit#gid=0) for the raw scorecard data for all agencies. 
