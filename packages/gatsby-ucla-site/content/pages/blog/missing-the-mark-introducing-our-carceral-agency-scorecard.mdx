---
title: "Missing the Mark: Data Transparency Scorecard"
path: blog/scorecard
featured: false
...
* **Cumulative deaths:** the agency reports the total number of individuals who have died with or from COVID-19 while incarcerated in a particular facility

  * Note: Some agencies do not include people who were positive for COVID-19 but were found to have died of another cause. Our position is that agencies should include all people who had COVID-19 and died, and note whether infection was the cause of their death.
* **Cumulative tests:** the agency reports the total number of tests performed on incarcerated individuals throughout the pandemic

  * Note: While a few agencies report the number of people tested, the ideal metric is the number of tests administered. Monitoring for COVID-19 requires regular testing and reporting the number of people tested obscures the regularity of testing.
* **Active cases:** the agency reports number of individuals currently incarcerated at a particular facility who have an active infection of COVID-19 and have not been deemed recovered 
* **Total population:** the agency reports the total number of individuals incarcerated within a particular facility

  * Note: As with all other metrics, agencies only get points for including total population on their COVID-19 dashboards, not for reporting population elsewhere on their website.

For staff:

* **Cumulative cases:** the agency reports total number of confirmed COVID-19 cases among staff members at a particular facility
...
* **Contextualized historically:** historical trends of some type are displayed on the agency website
...
We assigned standard letter grades to each agency after calculating the percentage of all points granted out of a maximum total of 24. The letter grades are associated with score ranges as follows:
