...
![](screen-shot-2021-03-15-at-9.02.57-pm.png)
...
The scorecard for each state agency is displayed on each state page. The scorecards for the Federal Bureau of Prisons and for U.S. Immigration and Customs Enforcement will be added to their respective pages soon. [Click here](https://docs.google.com/spreadsheets/d/1ygkFpF7NVX4qfMs6_spaLM3Aev-JvnGakvWPCkDNuDk/edit#gid=0) for the raw scorecard data for all 53 state and federal agencies. 
...
* **Cumulative tests:** The agency reports the total number of tests performed on incarcerated individuals throughout the pandemic. (Note: While a few agencies report the number of people tested, the ideal metric is the number of tests administered. Monitoring for COVID-19 requires regular testing and reporting the number of people tested obscures the regularity of testing.)
...
* **Total population:** The agency reports the total number of individuals incarcerated within a particular facility. (Note: As with all other metrics, agencies only get points for including total population on their COVID-19 dashboards, not for reporting population elsewhere on their website.)

**Data Reporting Metrics — Staff:**

* **Cumulative cases:** The agency reports the total number of confirmed COVID-19 cases among staff members at a particular facility.
