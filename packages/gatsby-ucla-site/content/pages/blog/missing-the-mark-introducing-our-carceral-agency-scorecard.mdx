...
The table below displays the grades, as well as a summary of scores, for each agency. Click on an agency to see its full scorecard. Click here for the raw scorecard data. Please let us know if you use this scorecard as a tool to advocate for better data transparency and quality in your state.
