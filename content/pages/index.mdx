...
<HomeIntro
  ...
  subtitle="UCLA Law"
  body="We collect and report data on COVID in prisons, jails, and immigration detention centers, as well as pandemic-related prison and jail releases, legal filings and court orders, and grassroots and community organizing efforts. Our team is still in the process of adding all of our facility-level data to the national and state maps. Please check back regularly for updates."
/>
<HomeMap title="Showing ${metric} in carceral facilities" />
<HomeMapTooltip />
<HomeTable
...
<HomeSponsors
  ...
  logos={[
    { image: "/images/cdc-logo.svg", link: "", alt: "CDC Logo" },
    {
