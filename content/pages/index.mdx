...
table:
  ...
  note:
    - (set home_table_notes in en.json used instead for markup)
vaccineTable:
...
This map tracks COVID confirmed cases and deaths in jails and prisons across the US. The data are collected daily from self-reported counts from state and local Department of Corrections websites.
