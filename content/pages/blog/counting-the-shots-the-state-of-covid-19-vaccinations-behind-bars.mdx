...
*Note: In addition to the data on that we collect directly from agencies, we also included information on vaccination numbers and rates from news sources and leveraged data from [The Marshall Project ](https://www.themarshallproject.org/2020/05/01/a-state-by-state-look-at-coronavirus-in-prisons)and [The Associated Press](https://www.themarshallproject.org/2020/05/01/a-state-by-state-look-at-coronavirus-in-prisons) for this piece. Data reflect the most recent information available as of June 24, 2021. See [here](https://docs.google.com/spreadsheets/d/1kh7vldEWeZV2g7h1XtxDa7meXfHb96eqkp1jyYJfRHc/edit#gid=820434652) for more details.*