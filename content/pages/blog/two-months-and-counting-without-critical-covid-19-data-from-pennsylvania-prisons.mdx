---
meta:
  title: Two Months (And Counting) Without Critical COVID-19 Data from Pennsylvania Prisons
  description: In January, the Pennsylvania Department of Corrections
    removed its data dashboard due to “technical challenges.” More than two months
    later, we’re still missing critical data.
