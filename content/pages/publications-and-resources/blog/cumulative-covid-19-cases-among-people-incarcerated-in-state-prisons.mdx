---
meta:
  title: Which State and Federal Carceral Systems Report COVID-19 Data?
  description: Since the beginning of the pandemic, the UCLA Law COVID-19 Behind Bars Data Project has been collecting COVID-19 data from the online dashboards maintained by correctional agencies nationwide.
title: Which State and Federal Carceral Systems Report COVID-19 Data?
path: blog/data-reporting
featured: true
author: Erika Tyagi and Liz DeWolf
date: 2021-02-17T17:00:00.000Z
description: Since the beginning of the pandemic, the UCLA Law COVID Behind
  ...
  of February 17, 2021.
socialDescription: Since the beginning of the pandemic, the UCLA Law COVID-19
  Behind Bars Data Project has been collecting COVID-19 data from the online
  dashboards maintained by correctional agencies nationwide.
socialImage: images/cases-incarcerated-3.png
isBlogPost: true
template: blog
---
...
The maps include all 50 state departments of corrections (DOCs), the District of Columbia’s Department of Corrections, the Federal Bureau of Prisons (BOP), which manages federal prisons, and the U.S. Immigration and Customs Enforcement (ICE), which manages immigration detention centers. The maps do not include data for jails.

###### **Cumulative COVID-19 cases among incarcerated people**

Carceral agencies generally define cumulative COVID-19 cases as the number of individuals who have ever tested positive for COVID-19 while incarcerated at a particular facility. Some agencies only report in the aggregate, and others do not report this data at all. As of February 17, 2021, only four state DOCs do not report cumulative cases among incarcerated people: Massachusetts, Missouri, Pennsylvania, and Wyoming.

![](images/cases-incarcerated-3.png "Cumulative COVID-19 cases among incarcerated people")

###### **COVID-19 deaths among incarcerated people**

Correctional agencies vary in how they report the number of people who have died of COVID-19 while in their custody. Some agencies only report in the aggregate, and others do not report at all. As of February 17, 2021, only five state DOCs do not report deaths of incarcerated people: Arkansas, Illinois, Maine, Massachusetts, and Mississippi.
...
![](images/tests-incarcerated-5.png "COVID-19 tests administered to incarcerated people")
...
![](images/cases-staff-6.png "Cumulative COVID-19 cases among staff")
...
![](images/deaths-staff-6.png "Cumulative COVID-19 deaths among staff")

These visualizations represent the status of data reporting as of February 17, 2021.
