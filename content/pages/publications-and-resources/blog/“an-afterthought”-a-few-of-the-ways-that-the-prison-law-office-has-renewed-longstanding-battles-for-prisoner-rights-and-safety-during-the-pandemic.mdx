...
<i>
  {" "}
  This schematic diagram, originally drawn by a man incarcerated inside, was submitted
  as evidence in court to show that those inside Joshua Hall could not safely social
  distance.{" "}
</i>
